...
//			j -= 784426;
	...
	public void replaceBlocksForBiome(int i, int j, byte abyte0[], BiomeGenBase abiomegenbase[]) {
		byte byte0 = 64;
		double d = 0.03125D;
		sandNoise = field_909_n.generateNoiseOctaves(sandNoise, i << 4, 0.0D, j << 4, 16, 1, 16, d, 1.0D, d);
		gravelNoise = field_909_n.generateNoiseOctaves(gravelNoise, i << 4, 109.0134D, j << 4, 16, 1, 16, d, 1.0D, d);
		stoneNoise = field_908_o.generateNoiseOctaves(stoneNoise, i << 4, 0.0D, j << 4, 16, 1, 16, d * 2D, d * 2D,
				d * 2D);
		for (int k = 0; k < 16; k++) {
			for (int l = 0; l < 16; l++) {
				BiomeGenBase biomegenbase = abiomegenbase[k << 4 | l];
				boolean flag = sandNoise[k << 4 | l] + rand.nextDouble() * 0.2D > 0.0D;
				boolean flag1 = gravelNoise[k << 4 | l] + rand.nextDouble() * 0.2D > 3D;
				int i1 = (int) (stoneNoise[k << 4 | l] / 3D + 3D + rand.nextDouble() * 0.25D);
				int j1 = -1;
	...
	public void populate(IChunkProvider ichunkprovider, int i, int j) {
		...
		if (rand.nextInt(64) == 0) {
			...
			int y = rand.nextInt(32) + 40;
			int z = l + rand.nextInt(16) + 8;
			(new WorldGenRavine()).generate(worldObj, rand, x, y, z);
		}
		if (rand.nextInt(32) == 0) {
			int x = k + rand.nextInt(16) + 8;
			int y = rand.nextInt(64) + 24;
			int z = l + rand.nextInt(16) + 8;
			(new WorldGenStalactiteCave()).generate(worldObj, rand, x, y, z);
		}
		if (rand.nextInt(4) == 0) {
		...
		if (rand.nextInt(20) < 5) {
			...
			int j9 = rand.nextInt(60);
			int i12 = l + rand.nextInt(16);
			(new WorldGenSponge()).generate(worldObj, rand, i6, j9, i12);
		}
		...
		if (biomegenbase != BiomeGenBase.alpha) {
			for (int k2 = 0; k2 < 2; k2++) {
				...
				(new WorldGenMinableCloud(mod_NFC.pebble.blockID, 10, 2, 80)).generate(worldObj, rand, k4, l7, i11);
			}
			{
				int i6 = k + rand.nextInt(16);
				int j9 = rand.nextInt(128);
				int i12 = l + rand.nextInt(16);
				(new WorldGenMinable(mod_NFC.pebble.blockID, 32)).generate(worldObj, rand, i6, j9, i12);
			}
		}
		
		{
			...
			int i12 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.mountainore.blockID, 1)).generate(worldObj, rand, i6, j9, i12);
		}
		...
		if (rand.nextInt(50) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.osmiumore.blockID, 9)).generate(worldObj, rand, k4, l7, i11);
		}
...

		{
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.zincore.blockID, 10)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(5) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinableCloud(mod_NFC.boronore.blockID, 4, 0, 10)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(16) == 1) {
			...
			int l7 = rand.nextInt(50);
			int i11 = l + rand.nextInt(16);
			(new WorldGenConcentrated(mod_NFC.silverore.blockID, 12, 6, 8)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(20) == 1) {
			...
			int l7 = rand.nextInt(40);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.platinumore.blockID, 18)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(16) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.cobaltore.blockID, 16)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(5) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.chromeore.blockID, 10)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(25) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinableCloud(mod_NFC.titaniumore.blockID, 8, 3, 25)).generate(worldObj, rand, k4, l7, i11);
		}

		{
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.tungstenore.blockID, 1)).generate(worldObj, rand, k4, l7, i11);
		}

		{
			...
			(new WorldGenMinable(mod_NFC.FakeBedrock.blockID, 1)).generate(worldObj, rand, i3, j6, k9);
		}
		...
		if (rand.nextInt(32) == 1) {
			...
			int l7 = rand.nextInt(32);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.uranite.blockID, 16)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(10) == 1) {
			...
			int l7 = rand.nextInt(32);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.magnetiteore.blockID, 5)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1) {
			...
			int l7 = rand.nextInt(16);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.rubyore.blockID, 1)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1) {
			...
			int l7 = rand.nextInt(16);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.emeraldore.blockID, 1)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1) {
			...
			int l7 = rand.nextInt(16);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.sapphireore.blockID, 1)).generate(worldObj, rand, k4, l7, i11);
		}
...
//			int i9 = rand.nextInt(128);
//			int l11 = l + rand.nextInt(16);
//			(new WorldGenMinable(Block.cobblestone.blockID, 32)).generate(worldObj, rand, l5, i9, l11);
//		}
		...
		if (rand.nextInt(16) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenConcentrated(mod_NFC.anthraciteore.blockID, 9, 3, 10)).generate(worldObj, rand, k4, l7, i11);
		}
		
		{
			int k4 = k + rand.nextInt(16);
			int l7 = rand.nextInt(82);
			int i11 = l + rand.nextInt(16);
			(new WorldGenConcentrated(Block.oreCoal.blockID, 5, 2, 16)).generate(worldObj, rand, k4, l7, i11);
		}

		for (int k2 = 0; k2 < (1 + rand.nextInt(2)); k2++) {
			int k4 = k + rand.nextInt(16);
			int l7 = rand.nextInt(48) + 48;
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(Block.oreCoal.blockID, 12)).generate(worldObj, rand, k4, l7, i11);
		}

		{
			for (int k2 = 0; k2 < (3 + rand.nextInt(4)); k2++) {
				int k4 = k + rand.nextInt(16);
				int l7 = rand.nextInt(44) + 38;
				int i11 = l + rand.nextInt(16);
				(new WorldGenMinableCloud(mod_NFC.copperore.blockID, 4, 1, 16)).generate(worldObj, rand, k4, l7, i11);
			}
		}
		...
		if (rand.nextInt(3) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinableCloud(mod_NFC.copperore.blockID, 5, 1, 40)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1) {
			...
			int l7 = rand.nextInt(50);
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinableCloud(mod_NFC.aluminumore.blockID, 8, 2, 90)).generate(worldObj, rand, k4, l7, i11);
		}

		for (int k2 = 0; k2 < (3 + rand.nextInt(5)); k2++) {
			int k4 = k + rand.nextInt(16);
			int l7 = rand.nextInt(52) + 30;
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.tinore.blockID, 7)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinableCloud(mod_NFC.nickelore.blockID, 6, 4, 24)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(7) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinableCloud(mod_NFC.siliconore.blockID, 5, 4, 15)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(5) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.bismuthore.blockID, 15)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(4) == 1) {
			...
			int i11 = l + rand.nextInt(16);
			(new WorldGenMinable(mod_NFC.leadore.blockID, 12)).generate(worldObj, rand, k4, l7, i11);
		}
		...
		if (rand.nextInt(16) == 1) {
			...
			int i8 = l + rand.nextInt(16) + 8;
			(new WorldGenLakes(mod_NFC.OilStill.blockID)).generate(worldObj, rand, i1, l4, i8);
		}
		 ...
		 */
		for (int k12 = 0; k12 < i11 - 1; k12++) {
			int i13 = k + rand.nextInt(16) + 8;
			int j15 = rand.nextInt(80) + 64;
		...
		if (rand.nextInt(4) == 0) {
			for (int k12 = 0; k12 < i11 - 1; k12++) {
				...
				int j15 = rand.nextInt(80) + 64;
				int i18 = l + rand.nextInt(16) + 8;
				(new WorldGenFlowers(mod_NFC.bloodMoonFlower.blockID)).generate(worldObj, rand, i13, j15, i18);
			}
		}
		...
		if (rand.nextInt(32) == 0) {
			...
			int j19 = l + rand.nextInt(16) + 8;
			(new WorldGenFlowers(mod_NFC.biolumMushroom.blockID)).generate(worldObj, rand, j14, j16, j19);
		}
		if (biomegenbase == BiomeGenBase.seasonalForest) {
		...
		if ((biomegenbase == BiomeGenBase.forest || biomegenbase == BiomeGenBase.seasonalForest) && rand.nextInt(8) == 0) {
			int xPos = k + rand.nextInt(16) + 8;
			int yPos = rand.nextInt(128);
			int zPos = l + rand.nextInt(16) + 8;
			(new WorldGenBerryBush()).generate(worldObj, rand, xPos, yPos, zPos);
		}
